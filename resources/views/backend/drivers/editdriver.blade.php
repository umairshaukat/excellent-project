                ...
                <form id="form_driver_save" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-2 col-xs-12">
                      <img id="profileblah" src="{{ asset('public/assets/image/imagenotavailable.png') }}" class="img-responsive m-b-xs" alt="profile">
                      <div class="text-center">
                        <div id="fileupload" >
        <div class="myfileupload-buttonbar ">
            <label class="myui-button">
                <span >Upload</span>
            <input type="file" name="driver_img" class="btn btn-success" onchange="document.getElementById('profileblah').src = window.URL.createObjectURL(this.files[0])">
            </label>
        </div>
        </div>
      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input name="firstName" type="text" placeholder="John" value="
{{
$drivers[0]->first_name}}" class="form-control" required="">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
...
{{
$drivers[0]->last_name}}" name="lastName" placeholder="Smith" class="form-control" required="">
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" value="
{{
$drivers[0]->phone_no}}" name="phoneNumber" placeholder="+44749093345" class="form-control" required="">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
...
{{
$drivers[0]->email}}" type="text" placeholder="john@company.com" class="form-control" required="">
                          </div>
                        </div>
                      </div>
                      <div class="row">
...
{{
$drivers[0]->d_o_b}}" name="dob" class="form-control"> 
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
...
{{
$drivers[0]->nationality}}" type="text" placeholder="ex: German" class="form-control">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="selectedCarType" required="">
                              {{-- for loop for cars --}}
                              <option value="" selected>{{
$drivers[0]->preferred_service}}</option>
                              <option value="Don't have preferred. I can do any service" selected="selected">Don't have preferred. I can do any service</option>
                            </select>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input name="driverLicenceType" value="{{
$drivers[0]->driver_licence_type}}" type="text" placeholder="ex: B, C" class="form-control">
                          </div>
                        </div>
                      </div>
                    </div>
...
$drivers[0]->add_info_disp}}" name="add_info_disp" placeholder="Additional info for dispatcher"></textarea>
                    </div>
                  </div>
                  <div class="row m-b-md">
                    <div class="col-sm-12">
                      <h4>Additional Info (visible to Client)</h4>
                      <textarea class="form-control original-style" value="{{
$drivers[0]->add_info_client}}"  name="add_info_client" placeholder="Additional info for client"></textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                            ...
                            <input name="address_description" value="{{
$drivers[0]->address_discription}}" type="text" placeholder="Any other usefull infromation for primary address" class="form-control" required="">
                          </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <select name="lang" id="language" class="form-control">
                      <option value="{{
$drivers[0]->language}}" selected>{{
$drivers[0]->language}}</option>
                  ...
                  <div class="row m-t-md">
                    <div class="col-md-6">
                      <div class="form-group" >
                        ...
                        <input name="carBrand" type="text" value="{{
$drivers[0]->car_brand}}" placeholder="ex: Mercedes-Benz" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Car Model</label>
                        <input name="carModel" type="text" value="{{
$drivers[0]->car_model}}" placeholder="ex: S Class Lux" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="carColor" type="text" value="{{
$drivers[0]->car_color}}"  placeholder="ex: Black" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Car plate no.</label>
                        <input name="carRegNo"  value="{{
$drivers[0]->car_no_plate}}" type="text" placeholder="ex: YD16DHA" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="driverLicenseNumber" value="{{
$drivers[0]->car_no_plate}}" type="text" placeholder="ex: 1897230101" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                      ...
                      <div class="form-group field-changed" ng-class="{'field-changed' : !vm.driverDetailsForm.region.$pristine }">
                        <label>Covered areas</label>
                           <select name="covered_areas" class="form-control">
                             <option value="{{
$drivers[0]->coverd_area}}" selected>{{
$drivers[0]->coverd_area}}</option>
                    ...
                    <div class="col-md-6">
                      <div class="form-group" ng-class="{'field-changed' : !vm.driverDetailsForm.paymentMethod.$pristine }">
                        ...
                        <select name="paymentMethod" ng-model="vm.driverModel.paymentMethod" class="form-control ng-pristine ng-untouched ng-valid ng-empty" ng-readonly="!vm.driverModel.isAdmin">
                          <option value="{{
$drivers[0]->payment_method}}" selected="selected">{{
$drivers[0]->payment_method}}</option>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="paymentAccount" value="{{
$drivers[0]->account}}" type="text" placeholder="ex: john@gmail.com or 1897230101" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Payment period</label>
                        <input name="paymentPeriod" value="{{
$drivers[0]->payment_period}}" type="text" placeholder="ex: Every 2 weeks, on 15'th each month" class="form-control">
                      </div>
                    </div>
                  </div>
                      ...
                      <edit-driver-document class="m-t-md ng-isolate-scope" document-name="'Driver licence'" document-model="vm.driverModel.driverLicence">
                        <div class="row m-b-xl">
                          <div class="col-sm-12">
                            <div class="row">
                              <div class="col-md-12">
                                <h3 class="ng-binding">Driver licence front:</h3>
                              </div>
                            </div>
                            <div class="row">
...
$drivers[0]->driver_licence_exp_date}}"  name="documentDate" placeholder="Expiration date" autocomplete="off">
                                </div>
                              </div>
                              <div class="col-md-5">
                                <input type="text" class="form-control" value="{{
$drivers[0]->doc_no}}"  name="documentNumber" placeholder="Document number">
                              </div>
                              <div class="col-md-2">
                      <div class="text-center">
                        <div id="fileupload" >
        <div class="myfileupload-buttonbar ">
            <label class="myui-button">
                <span >Upload</span>
            <input type="file" id="licence_img_front" class="btn btn-success" name="licence_img_front" onchange="document.getElementById('licesnces').src = window.URL.createObjectURL(this.files[0]);document.getElementById('show_licsense').style.display = 'block';">
            </label>
        </div>
                      </div></div>
                              </div>
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="row">
                              <div class="col-md-5">
                                <div class="form-group">
                                  <input type="date" class="form-control" value="{{
$drivers[0]->driver_licence_exp_date}}" name="pco_documentDate" placeholder="Expiration date" autocomplete="off">
                                </div>
                              </div>
                              <div class="col-md-5">
                                <input type="text" class="form-control" value="{{
$drivers[0]->doc_no}}"  name="pco_documentNumber" placeholder="Document number" autocomplete="off">
                              </div>
                              <div class="col-md-2">
                      <div class="text-center">
                        <div id="fileupload" >
        <div class="myfileupload-buttonbar ">
            <label class="myui-button">
                <span >Upload</span>
            <input type="file" class="btn btn-success" id="licence_img_back" name="licence_img_back" onchange="document.getElementById('driver_back_license').src = window.URL.createObjectURL(this.files[0]);document.getElementById('driver_back_show_license').style.display = 'block';">
            </label>
        </div>
                      </div></div>
                              </div>
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="row">
                              <div class="col-md-5">
                                <div class="form-group">
                                  <input type="date" class="form-control" value="{{
$drivers[0]->pco_licence_exp_date}}"  name="pco_documentDate" placeholder="Expiration date" autocomplete="off" >
                                </div>
                              </div>
                              <div class="col-md-5">
                                <input type="text" class="form-control" value="{{
$drivers[0]->pco_doc_no}}" name="documentNumber" placeholder="Document number">
                              </div>
                              <div class="col-md-2">
                      <div class="text-center">
                        <div id="fileupload" >
        <div class="myfileupload-buttonbar ">
            <label class="myui-button">
                <span >Upload</span>
            <input type="file" class="btn btn-success" id="pco_img" name="pco_img" onchange="document.getElementById('pco_license').src = window.URL.createObjectURL(this.files[0]);document.getElementById('pco_show_license').style.display = 'block';">
            </label>
        </div>
                      </div></div>
                              </div>
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="row">
                              <div class="col-md-5">
                                <div class="form-group">
                                  <input type="date" class="form-control" value="{{
$drivers[0]->insurance_expire}}" name="insurance_documentDate" placeholder="Expiration date">
                                </div>
                              </div>
                              <div class="col-md-5">
                                <input type="text" class="form-control" value="{{
$drivers[0]->insurance_no}}" name="insurancedocumentNumber" placeholder="Document number" autocomplete="off">
                              </div>
                              <div class="col-md-2">
                      <div class="text-center">
                        <div id="fileupload" >
        <div class="myfileupload-buttonbar ">
            <label class="myui-button">
                <span >Upload</span>
            <input type="file" class="btn btn-success" id="insurance_img" name="insurance_img" onchange="document.getElementById('insurance_license').src = window.URL.createObjectURL(this.files[0]);document.getElementById('insurance_show_license').style.display = 'block';">
            </label>
        </div>
                      </div></div>
                              </div>
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="row">
                              <div class="col-md-5">
                                <div class="form-group">
                                  <input type="date" class="form-control" value="{{
$drivers[0]->passport_exp_date}}"  
                                   name="passport_documentDate" placeholder="Expiration date">
                                </div>
                              </div>
                              <div class="col-md-5">
                                <input type="text" class="form-control" value="{{
$drivers[0]->passport_no}}" name="passport_documentNumber" placeholder="Document number" autocomplete="off">
                              </div>
                              <div class="col-md-2">
                      <div class="text-center">
                        <div id="fileupload" >
        <div class="myfileupload-buttonbar ">
            <label class="myui-button">
                <span >Upload</span>
            <input type="file" class="btn btn-success" id="passport_img" name="passport_img" onchange="document.getElementById('passport_license').src = window.URL.createObjectURL(this.files[0]);document.getElementById('passport_show_license').style.display = 'block';">
            </label>
        </div>
                      </div></div>
                              </div>
